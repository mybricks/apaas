...
import { useWorkspaceConetxt, useUserContext, useFilesMenuTreeContext } from '@workspace/context'
...
import { mergrFileData } from "@workspace/utils/file";
...
export function Create({
  ...
  const DISABLED_CREATE_APPS = ['mybricks-app-th5'];
    ...
    >
      ...
      >
        ...
        {['mpsite'].includes(app?.extName) ? (
          <Form.Item label='类型' name="type" initialValue="miniprogram">
            <Select
              options={[
